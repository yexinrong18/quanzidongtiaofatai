...
<Library LVVersion="15008000">
	...
	<Item Name="HEX TO ASCII.vi" Type="VI" URL="../HEX TO ASCII.vi"/>
	<Item Name="使用例子.vi" Type="VI" URL="../使用例子.vi"/>
	<Item Name="labview与三菱PLC通讯(main).vi" Type="VI" URL="../labview与三菱PLC通讯(main).vi"/>
